...
public:
	...
	inline zenArrayStatic<ValuePointer>&	GetPropertyValues(){return maPropertyValue;}
	ValuePointer							GetPropertyValue(zenHash32 _hPropertyName)const;
	void									ResetPropertyValues();

	virtual AssetItem::enumType				GetType()const=0;									//!< Child class return the Asset type they represent
...
protected:
	...
	zenArrayStatic<ValuePointer>			maPropertyValue;			//!< Asset properties values
