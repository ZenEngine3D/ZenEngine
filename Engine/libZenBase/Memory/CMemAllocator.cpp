...
void Allocator::Header::Set(Allocator* _pAllocator, zenU32 _uAllocOffset, size_t _uAllocSize, bool _bIsArray)
{
...
void* Allocator::AddAlloc( size_t _uWantedSize, size_t _uExtraSize, zenU32 _uAlign, void* _pAllocation, const bool _bIsArray )
{
	...
	zenU8* pAllocAligned								= static_cast<zenU8*>(_pAllocation) + sizeof(Header) + _uExtraSize;
