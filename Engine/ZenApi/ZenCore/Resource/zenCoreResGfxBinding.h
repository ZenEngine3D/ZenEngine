...
namespace zen { namespace zenRes {	
	...
	ZENClassResourceRefDeclare(zGfxBlend, zenConst::keResType_GfxBlend)
	public:
	...
	ZENClassResourceRefDeclare(zGfxDepthStencil, zenConst::keResType_GfxDepthStencil)
	public:
	...
	ZENClassResourceRefDeclare(zGfxRasterizer, zenConst::keResType_GfxRasterizer)
	public:
