...
namespace zbLog
{
	...
	void ManagerLog::Reset()
	{
		...
		SetActive(keLogOut_StdOut, zenConst::keLog_General );
		SetActive(keLogOut_StdOut, zenConst::keLog_Game );
		SetActive(keLogOut_StdOut, zenConst::keLog_Critical );
		SetActive(keLogOut_StdOut, zenConst::keLog_Assert );
		SetActive(keLogOut_StdOut, zenConst::keLog_Warning );
		SetActive(keLogOut_StdOut, zenConst::keLog_FileIO );
		SetActive(keLogOut_StdOut, zenConst::keLog_ResTexture );
		SetActive(keLogOut_StdOut, zenConst::keLog_ResMaterial );
		SetActive(keLogOut_StdOut, zenConst::keLog_ResGeometry );
		SetActive(keLogOut_StdOut, zenConst::keLog_DebugInfo );
		SetActive(keLogOut_StdOut, zenConst::keLog_ExportError);
		SetActive(keLogOut_StdOut, zenConst::keLog_ExportSuccess);
	}
	...
	//==================================================================================================
	void ManagerLog::Log( zenConst::eLogType _eLogType, const char* _zFormat, const va_list _pArgs )
	{	
	...
	//==================================================================================================
	void ManagerLog::Printf( zenConst::eLogType _eLogType, const char* _zFormat, const va_list _pArgs )
	{	
