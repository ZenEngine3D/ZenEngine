...
namespace zen { namespace zenConst {
	...
	extern const float		kfPI			= 3.141592653589793f;
	extern const float		kfPI2x			= 6.283185307179586f;
	extern const float		kfPIOn2			= 1.570796326794896f;
	extern const float		kfPIInv			= 1.0f/3.141592653589793f;
	extern const float		kfPI2xInv		= 1.0f/6.283185307179586f;
	extern const float		kfPIOn2Inv		= 1.0f/1.570796326794896f;
	extern const double		kdPI			= 3.141592653589793;
	extern const double		kdPI2x			= 6.283185307179586;
	extern const double		kdPIOn2			= 1.570796326794896;
	extern const double		kdPIInv			= 1.0/3.141592653589793;
	extern const double		kdPI2xInv		= 1.0/6.283185307179586;
	extern const double		kdPIOn2Inv		= 1.0/1.570796326794896;
