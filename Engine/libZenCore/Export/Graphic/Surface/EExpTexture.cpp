...
//=================================================================================================
zenResID CreateGfxTexture2D(zenConst::eTextureFormat _eFormat, zenFlagResTexCreate _CreationFlags, zenVec2U16 _vDim, const zenArrayBase<zenU8>& _aRawData)
{
	...
	return EMgr::Export.CreateItem( zenResID::kePlatformType_GFX, zenConst::keResType_GfxTexture2D, pExportInfo );
}
