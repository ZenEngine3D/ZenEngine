...
public:
	...
	awU32							muIndiceCount;		//!< Number of indice in array (maIndices.Count/muIndiceSize)	
	awU16							muIndiceSize;		//!< Size of each indice (2Bytes, 4Bytes, ...)
	awU32							muPrimitiveCount;	//!< Number of primitives generated by indices
