...
namespace ERes
{
	...
	class GfxShaderBinding_DX11 : public Resource
	{
		...
		{
			zenArrayStatic<GfxShaderRef>		maGfxShaderRef;			//!< Shader used for each shader stage			
			zenMap<zenU32>::Key32			mdCBuferPerParam;		//!< Bitmask of each ShaderParam containing this parameter name
	...
	{	
		struct InstanceInfo : public EExp::SerialGfxMeshStrip_DX11
		{
			...
			zenArrayStatic<GfxShaderParamRef>				maShaderParamRef;		//!< Array of all ShaderParam used by all Shaders stage
	...
	public:
		...
		void			SetValue(const zenHash32& _hTextureName, GfxTexture2DRef _rTexture );
		void			SetValue(const zenHash32& _hTextureName, GfxSamplerRef _rSampler );
		void			SetValue(const zenHash32& _hTextureName, GfxTexture2DRef _rTexture, GfxSamplerRef _rSampler );
		//------------------------------------------------------------------------------------------------
	};
