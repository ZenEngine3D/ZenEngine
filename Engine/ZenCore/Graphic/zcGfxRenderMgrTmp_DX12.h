#pragma once
#ifndef __zCore_Gfx_Renderer_ManagerTmp_DX12_h__
#define __zCore_Gfx_Renderer_ManagerTmp_DX12_h__

// Copy/Paste from Mini Engine for basic functionalities
//! @todo 1 Remove this and implement it myself
#include <vector>
#include <queue>
#include <mutex>
#include <stdint.h>

#define	ASSERT(cond, ...)			zenAssert(cond)
#define ASSERT_SUCCEEDED( hr, ... ) zenAssert(SUCCEEDED(hr))
