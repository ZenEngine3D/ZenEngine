#pragma once
#ifndef __zCore_Gfx_State_Manager_h__
#define __zCore_Gfx_State_Manager_h__ 
...
#include ZENHeaderRenderer( zcGfxStateManager )

namespace EMgr { extern zcGfx::ManagerState GfxState; }
