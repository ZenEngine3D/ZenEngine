...
void Command::ConfigureBase( const zcRes::GfxRenderPassRef& _rRenderPass, float _fPriority, const zcRes::GfxMeshStripRef& _rMeshStrip )
{
	...
	mSortId.muGPUPipelineMode	= Command::keGpuPipe_VertexPixel;
	...
	mSortId.muVertexShaderID	= 0;//! @todo finish this
	mSortId.muInputShaderID		= 0;//! @todo finish this
...
void Command::ConfigureBase( const zcRes::GfxRenderPassRef& _rRenderPass, float _fPriority, zU32 _uShaderBindingID, Command::eGPUPipelineMode _eGPUPipelineMode )
{
	mrRenderPass				= _rRenderPass;
	mSortId.mSortKeyHi			= 0;
	mSortId.mSortKeyLo			= 0;
