...
void zGfxCBuffer::SetValue(const zHash32& _hParamName, float _fValue)
{
	zenAssertMsg(mpResource, "No valid resource assigned");
	mpResource->SetValue(_hParamName, _fValue);
}

void zGfxCBuffer::SetValue(const zHash32& _hParamName, zU32 _uValue)
{
	zenAssertMsg(mpResource, "No valid resource assigned");
	mpResource->SetValue(_hParamName, _uValue);
}

void zGfxCBuffer::SetValue(const zHash32& _hParamName, const zVec2F& _vValue)
{
	zenAssertMsg(mpResource, "No valid resource assigned");
	mpResource->SetValue(_hParamName, _vValue);
}

void zGfxCBuffer::SetValue(const zHash32& _hParamName, const zVec3F& _vValue)
{
	zenAssertMsg(mpResource, "No valid resource assigned");
	mpResource->SetValue(_hParamName, _vValue);
}

void zGfxCBuffer::SetValue(const zHash32& _hParamName, const zVec4F& _vValue)
{
	zenAssertMsg(mpResource, "No valid resource assigned");
	mpResource->SetValue(_hParamName, _vValue);
}

void zGfxCBuffer::SetValue(const zHash32& _hParamName, const zenMath::Matrix& _matValue)
{
	zenAssertMsg(mpResource, "No valid resource assigned");
