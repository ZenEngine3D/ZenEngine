...
namespace zcExp
{
bool SerialGfxInputSignature_DX11::Serialize( zcExp::Serializer_Base& _Serializer )
{
	return FALSE; 
}

zResID SerialGfxInputSignature_DX11::CallbackGetItemID(zenConst::eResPlatform _ePlatform, zenConst::eResType _eType, zenConst::eResSource _eSource, const zcExp::ExportInfoBase* _pExportInfo, bool& _bExistOut)
{
...
bool SerialGfxInputSignature_DX11::ExportStart()
{
	...
	zcExp::SerialShader_DX11* pShaderParent	= EMgr::SerialItems.GetItem<zcExp::SerialShader_DX11>( pExportInfo->mParentShaderID);
	if( pShaderParent )
	{
