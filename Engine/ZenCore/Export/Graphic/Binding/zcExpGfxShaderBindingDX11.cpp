...
namespace zcExp
{
	bool SerialGfxShaderBinding_DX11::Serialize( zcExp::Serializer_Base& _Serializer )
	{
		return FALSE; 
	}
	...
	bool SerialGfxShaderBinding_DX11::ExportStart()
	{
		...
		{
			zcExp::SerialShader_DX11* pSerialShader = EMgr::SerialItems.GetItem<zcExp::SerialShader_DX11>( mSerial.maShaderID[stageIdx] );
			if( pSerialShader )
			{				
