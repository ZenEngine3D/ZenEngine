...
namespace zcExp
{
	...
	bool SerialGfxSampler_DX11::ExportWork(bool _bIsTHRTask)
	{
		...
		else
		{
			...
			case zenConst::keTexFilter_Point:
			{
				...
				{
				case zenConst::keTexFilter_Point:	mSerial.mSamplerDesc.Filter = D3D11_FILTER_MIN_MAG_MIP_POINT;				break;
				case zenConst::keTexFilter_Bilinear:	mSerial.mSamplerDesc.Filter = D3D11_FILTER_MIN_LINEAR_MAG_MIP_POINT;		break;		
				}break;
			}
			case zenConst::keTexFilter_Bilinear:
			{
				switch( pExportInfo->meFilterMin )
				{
				case zenConst::keTexFilter_Point:	mSerial.mSamplerDesc.Filter = D3D11_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT;	break;
				case zenConst::keTexFilter_Bilinear:	mSerial.mSamplerDesc.Filter = D3D11_FILTER_MIN_MAG_LINEAR_MIP_POINT;		break;		
				}break;
			}
			}
		}
	...
	zResID SerialGfxSampler_DX11::CallbackGetItemID(zenConst::eResPlatform _ePlatform, zenConst::eResType _eType, zenConst::eResSource _eSource, const zcExp::ExportInfoBase* _pExportInfo, bool& _bExistOut)
	{
	...
	bool SerialGfxSampler_DX11::Serialize( zcExp::Serializer_Base& _Serializer )
	{
	...
	zResID SerialGfxBlend_DX11::CallbackGetItemID(zenConst::eResPlatform _ePlatform, zenConst::eResType _eType, zenConst::eResSource _eSource, const zcExp::ExportInfoBase* _pExportInfo, bool& _bExistOut)
	{
	...
	bool SerialGfxBlend_DX11::Serialize( zcExp::Serializer_Base& _Serializer )
	{
		if( Super::Serialize(_Serializer) )
			return false;
	...
	zResID SerialGfxDepthStencil_DX11::CallbackGetItemID(zenConst::eResPlatform _ePlatform, zenConst::eResType _eType, zenConst::eResSource _eSource, const zcExp::ExportInfoBase* _pExportInfo, bool& _bExistOut)
	{
	...
	bool SerialGfxDepthStencil_DX11::Serialize( zcExp::Serializer_Base& _Serializer )
	{
		if( Super::Serialize(_Serializer) )
			return false;
	...
	zResID SerialGfxRasterizer_DX11::CallbackGetItemID(zenConst::eResPlatform _ePlatform, zenConst::eResType _eType, zenConst::eResSource _eSource, const zcExp::ExportInfoBase* _pExportInfo, bool& _bExistOut)
	{
	...
	bool SerialGfxRasterizer_DX11::Serialize( zcExp::Serializer_Base& _Serializer )
	{
		if( Super::Serialize(_Serializer) )
			return false;
