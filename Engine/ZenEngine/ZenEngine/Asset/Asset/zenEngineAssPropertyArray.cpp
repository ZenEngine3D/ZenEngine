...
{		
	...
	PropertyArray* pNewDefinition		= zenNewPool zenAss::PropertyArray(_zName, _zDisplayName, _zDescription, _bShowInAssetDesc, _bIsEditable);
...
{	
	...
	ValueRef rArrayVal = zenNewPool ValueProperty(_rOwnerAsset, this);
